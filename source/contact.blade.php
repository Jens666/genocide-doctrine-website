...
@section('body')
<h1 class="font-serif text-gray-100">Contact</h1>
...
<form action="/contact" class="mb-12">
    <div class="flex flex-wrap mb-6 -mx-3">
        <div class="w-full md:w-1/2 mb-6 md:mb-0 px-3">
            <label class="block mb-2 text-gray-100 text-sm font-semibold" for="contact-name">
                Name
            </label>
        ...
        <div class="w-full px-3 md:w-1/2">
            <label class="block text-gray-100 text-sm font-semibold mb-2" for="contact-email">
                Email Address
            </label>
    ...
    <div class="w-full mb-12">
        <label class="block text-gray-100 text-sm font-semibold mb-2" for="contact-message">
            Message
        </label>
